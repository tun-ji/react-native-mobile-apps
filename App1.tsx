  ...
  return (
    ...
    >
      <Stack.Screen
        name="HomeScreen"
        component={Home}
        options={{ title: "App1 Home Screen" }}
      />
      <Stack.Screen
        name="Component1Screen"
        component={Component1}
        options={{ title: "Component 1", headerShown: false }}
      />
      <Stack.Screen
        name="Component2Screen"
        component={Component2}
        options={{ title: "Component 2" }}
      />
      <Stack.Screen
        name="Component4Screen"
        component={Component4}
        options={{ title: "Component 4" }}
      />
      <Stack.Screen
        name="Component5Screen"
        component={Component5}
        options={{ title: "Component 5" }}
      />
    </Stack.Navigator>
  );
};
