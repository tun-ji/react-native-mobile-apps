...
const Component6: React.FC = () => {
  ...
  return (
    <View>
      <Text style={styles.text}>Greetings from Component6.</Text>
      ...
      <View>
        <Button
          ...
          onPress={() => {
            fetchData(
              `https://jsonplaceholder.typicode.com/users/${userIdInput}`
            );
          }}
        />
      </View>
      ...
      <View>
        <TextInput
          onSubmitEditing={(event) => {
            fetchData(
              `https://jsonplaceholder.typicode.com/users/${event.nativeEvent.text}`
            );
          }}
          placeholder="Enter UserId (1 to 10) here. Press enter when done" // {/** There isn't an enter for ios  */...}
